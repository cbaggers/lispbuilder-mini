...
(defpackage #:lbm-sdl-mixer
  (:use #:cl #:cffi)
  (:nicknames #:sdl-mixer)
  (:documentation "The main package of `lbm-sdl-mixer'.")
  (:import-from #:lbm-sdl-mixer-cffi

   lbm-sdl-cffi::+CHANNELS+
   lbm-sdl-cffi::+DEFAULT-FREQUENCY+
   lbm-sdl-cffi::+DEFAULT-CHANNELS+
   lbm-sdl-cffi::+MAX-VOLUME+
   lbm-sdl-cffi::+CHANNEL-POST+
   lbm-sdl-cffi::SDL-MIXER-VERSION
   ;;		 lbm-sdl-cffi::VERSION
   lbm-sdl-cffi::+DEFAULT-FORMAT+

   lbm-sdl-cffi::CHUNK
   lbm-sdl-cffi::MUSIC
		 
   ;; lbm-sdl-cffi::this-fp
   ;; 		 lbm-sdl-cffi::gc-p
   ;; 		 lbm-sdl-cffi::simple-free
   )
