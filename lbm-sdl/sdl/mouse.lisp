...
(defvar mouse-left       lbm-sdl-cffi::SDL-BUTTON-LEFT)
(defvar mouse-middle     lbm-sdl-cffi::SDL-BUTTON-MIDDLE)
(defvar mouse-right      lbm-sdl-cffi::SDL-BUTTON-RIGHT)
(defvar mouse-wheel-up   lbm-sdl-cffi::SDL-BUTTON-WHEEL-UP)
(defvar mouse-wheel-down lbm-sdl-cffi::SDL-BUTTON-WHEEL-DOWN)
(defvar mouse-x1         lbm-SDL-CFFI::SDL-BUTTON-X1)
(defvar mouse-x2         lbm-SDL-CFFI::SDL-BUTTON-X2)
