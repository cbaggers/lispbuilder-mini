...
(cffi:define-foreign-library sdl-glue
  (:windows "liblbm-sdl-glue.dll")
  (:darwin (:or (:framework "liblbm-sdl-glue")
                (:default "liblbm-sdl-glue")))
  (:unix (:or "liblbm-sdl-glue"
              "liblbm-sdl-glue.so"))
  (t (:or)))
...
(defun load-sdl-library ()
  ...
  (when (handler-case (cffi:use-foreign-library sdl-glue)
    ...
    (progn
      ...
      (pushnew :lbm-sdl-audio *features*))))
