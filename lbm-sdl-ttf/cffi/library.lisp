...
(cffi:define-foreign-library sdl-ttf-glue
  (:darwin (:or "liblbm-sdl-ttf-glue"
            "lbm-sdl-ttf-glue"))
  (:windows (:or "liblbm-sdl-ttf-glue.dll"
             "lbm-sdl-ttf-glue.dll"))
  (:unix "liblbm-sdl-ttf-glue.so")
  (t (:or)))
...
(defun load-library ()
  ...
  (when (handler-case (cffi:use-foreign-library sdl-ttf-glue)
    ...
    (progn
      ...
      (pushnew :lbm-sdl-ttf-glue *features*))))
